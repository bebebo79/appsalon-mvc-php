...
<p class="descripcion-pagina">Elige los servicios a continuacion</p>
...
<div id="app">
    ...
    <div id="paso-3" class="seccion contenido-resumen">
        <h2>Resumen</h2>
        <p class="text-center">Confirma que la informacion sea correcta</p>
